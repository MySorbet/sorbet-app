...
export const AllTasksCompleteMockDataNoTransactions: Story = {
  parameters: {
    msw: [
      mockDashboardHandlerAllTasksComplete,
      mockOverviewHandlerNoTransactions,
    ...
    localStorage: {
      [`sorbet:has-shared:${mockUser.id}`]: true,
      [`sorbet:is-tasks-closed:${mockUser.id}`]: false,
    },
  },
};

export const AllTasksCompleteMockDataAndTasksClosedNoTransactions: Story = {
  parameters: {
    msw: [
      mockDashboardHandlerAllTasksComplete,
      mockOverviewHandlerNoTransactions,
