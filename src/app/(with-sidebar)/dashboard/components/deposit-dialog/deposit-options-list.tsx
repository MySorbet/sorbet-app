...
export const DepositOptionsList = ({
    ...
    const [hoveredOption, setHoveredOption] = useState<DepositOption | null>(null);
    ...
    return (
        <button
            ...
            className={cn(
                ...
                'focus:outline-none focus:ring-2 focus:ring-sorbet focus:ring-offset-2',
                isActive
                    ? 'border-sorbet bg-sorbet/5'
