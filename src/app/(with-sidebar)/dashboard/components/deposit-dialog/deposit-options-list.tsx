...
interface DepositOptionsListProps {
  ...
  hasAEDAccount: boolean;
}

/**
 * Selection screen showing deposit options: USDC Wallet, USD Account, EUR Account, AED Account
 */
    ...
    <div className='flex flex-col gap-4 p-6'>
      ...
      <div className='flex flex-col gap-3'>
        ...
        <DepositOptionCard
          ...
          label='AED Account'
          onClick={() => handleSelect('aed')}
          disabled={!hasAEDAccount}
          isHovered={hoveredOption === 'aed'}
          onHover={(hovered) => setHoveredOption(hovered ? 'aed' : null)}
        />
      </div>
