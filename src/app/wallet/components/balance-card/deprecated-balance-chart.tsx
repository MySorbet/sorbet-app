...
export type DeprecatedBalanceHistory = { date: string; balance: number }[];

/**
 * @deprecated
 * The graph of balance history underneath the balance widget in the wallet page
 */
export const DeprecatedBalanceChart: React.FC<{
  balanceHistory: DeprecatedBalanceHistory | undefined;
}> = ({ balanceHistory }) => {
