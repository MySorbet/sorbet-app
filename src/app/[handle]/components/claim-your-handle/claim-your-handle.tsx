...
export const ClaimYourHandle = () => {
  return (
    <div className='@container size-full'>
      <div className='@5xl:mx-0 @5xl:max-w-none mx-auto flex h-full max-w-96 flex-col'>
        <div className='@5xl:flex-row flex flex-1 flex-col items-start gap-4 overflow-hidden p-6'>
          <div className='@5xl:w-auto @5xl:max-w-96 w-full'>
            <div className='@5xl:w-auto @5xl:max-w-96 @5xl:pt-20 animate-in fade-in-0 w-full duration-500'>
              <ClaimYourHandleForm />
            </div>
          </div>
