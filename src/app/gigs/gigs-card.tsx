...
export const GigsCard = ({
  ...
  return (
    <div className='flex flex-col gap-4 p-4 sm:p-6 lg:p-4 bg-white shadow-[0px_0px_16px_4px_rgba(0,0,0,0.12)] rounded-xl border border-2 border-solid border-[#E5E8ED] cursor-pointer'>
