...
const SpotifyWidget = ({
  ...
  return (
    <div
      className='roundBorder relative flex h-full min-h-[270px] w-full flex-col rounded-xl'
    ...
    >
      ...
      <iframe
        className='spotifyWidget roundBorder absolute min-h-[270px] w-full rounded-xl'
